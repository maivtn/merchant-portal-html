...
function ensureShell() {
  ...
  app.innerHTML = `
    ...
    <main id="main-slot" class="py-6 pb-24"></main>
...
function renderHeader() {
  ...
  el.innerHTML = `
    <div class="flex items-center justify-between py-4">
      ${showBack ? `<div class="w-28"><button data-action="back" class="btn-action-flat btn-action-sm inline-flex items-center gap-2 text-sm font-bold">${icon('arrow-left','w-4 h-4')} Back</button></div>` : ''}
