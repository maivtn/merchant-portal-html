...
function voucherDetailsContent() {
  return `<div class="space-y-8">
    ...
    <div><h4 class="mb-4 text-xs font-bold uppercase tracking-[0.18em] text-cream">Donation Amount</h4><div class="flex gap-4"><div class="relative"><select id="currency-select" class="h-14 w-28 appearance-none rounded-lg border border-line bg-black/30 pl-4 pr-10 text-sm font-semibold text-gold outline-none transition focus:border-gold sm:text-base"><option value="USD">USD</option><option value="VND">VND</option></select><span class="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 text-gold">${icon('chevron-down','w-4 h-4')}</span></div><input id="amount-input" type="text" placeholder="0.00" class="h-14 flex-1 rounded-lg border border-line bg-black/30 px-5 text-sm font-semibold text-cream outline-none transition placeholder:text-zinc-500 focus:border-gold sm:text-base"></div></div>
  </div>`;
}

function cardDetailsContent() {
  return `<div class="space-y-8">
    <div><h4 class="mb-4 text-xs font-bold uppercase tracking-[0.18em] text-cream">Select Currency & Value</h4><div class="flex gap-4"><div class="relative"><select id="currency-select" class="h-14 w-28 appearance-none rounded-lg border border-line bg-black/30 pl-4 pr-10 text-sm font-semibold text-gold outline-none transition focus:border-gold sm:text-base"><option value="USD">USD</option><option value="VND">VND</option></select><span class="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 text-gold">${icon('chevron-down','w-4 h-4')}</span></div><input id="card-value-input" type="text" placeholder="Enter value" class="h-14 flex-1 rounded-lg border border-line bg-black/30 px-5 text-sm font-semibold text-cream outline-none transition placeholder:text-zinc-500 focus:border-gold sm:text-base"></div></div>
