...
const mockGiftCards = [
  { id: 'GC-01', maskedNumber: '7624 **** **** 7563', value: 50, currency: 'USD', createdDate: 'Oct 15, 2025', status: 'Available', purpose: 'Food Support' },
  { id: 'GC-02', maskedNumber: '7624 **** **** 7564', value: 50, currency: 'USD', createdDate: 'Oct 15, 2025', status: 'Available', purpose: 'Children Education' },
  { id: 'GC-03', maskedNumber: '7624 **** **** 7562', value: 5000000, currency: 'VND', createdDate: 'Oct 15, 2025', status: 'Gifted', recipientName: 'Nguyen A', recipientEmail: 'nguyen_a@example.com', purpose: 'Elderly Care' },
  { id: 'GC-04', maskedNumber: '7624 **** **** 7561', value: 50, currency: 'USD', createdDate: 'Oct 15, 2025', status: 'Redeemed', redeemerName: 'Nguyen A', redeemerId: '1234 **** **** 6789', redeemerAddress: '568 National Highway 91, Thot Not, Can Tho', redeemedDate: 'Oct 30, 2025 09:00', redeemedAmount: 50, merchant: 'Phuong Nam Bookstore', location: 'Can Tho', hasProof: true, purpose: 'Scholarship Programs' }
];
...
function buildQrView() {
  ...
  document.getElementById('main-slot').innerHTML = fillTemplate('tpl-qr-view', {
    ...
    purpose: card?.purpose
      ? `<p class="mt-2 text-[11px] font-semibold uppercase tracking-[0.3em] text-gold sm:text-[13px]">${escapeHtml(card.purpose)}</p>`
      : ''
  });
  safeCreateIcons();
}
